using BatchProcessorServerUI.Model;
using BatchProcessorServerUI.Util;
using System.Diagnostics;
using System.Windows;

namespace BatchProcessorServerUI.ViewModel
{
    public class BatchProcessorViewModel
    {
        ...
        private void RunProcess(string arguments, bool waitForExit)
        {
            ...
            {
                FileName = "BatchProcessorServer.exe",
                Arguments = arguments,
        ...
        private void StopProcess()
        {
            ...
            {                
                ...
                process.Dispose();
                process = null;
                State.ConsoleText += System.Environment.NewLine + "Stopping BatchProcessorServer...";
            }
        }
